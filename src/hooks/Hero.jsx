  ...
  return (
    ...
    >
      {dots.map((dot, index) => (
        <div
          key={index}
          className={`absolute h-2 w-2 rounded-full ${dot.color} animate-pulse`}
          style={{
            top: dot.top,
            left: dot.left,
...
const ReactLogo = memo(() => (
  <div
    className="absolute right-24 top-24 w-32 h-32 opacity-20 z-0 animate-spin-slow text-blue-400 pointer-events-none"
    aria-hidden="true"
  >
    <svg
...
const BackgroundElements = memo(() => (
  ...
  >
    ...
    <div className="absolute right-16 bottom-16 text-6xl opacity-20 z-0 animate-float text-blue-300">
      ♕
    </div>
