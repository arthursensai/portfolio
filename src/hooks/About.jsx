            ...
            <motion.div variants={containerVariants} className="space-y-8">
              <motion.div variants={itemVariants} className="space-y-6">
                <p className="text-gray-700 leading-relaxed text-lg">
                  Hi, I'm{" "}
                  <span className="font-bold text-blue-600">Mohamed!</span> A
                  passionate full-stack developer with a deep interest in
                  building intelligent and interactive applications.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  My expertise lies in crafting efficient front-end experiences
                  while ensuring strong and scalable backend architecture. I
